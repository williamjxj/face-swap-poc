 ...
 */
export async function optimizeVideo(inputPath, {
  outputPath = null,
  width = 720,
  preset = 'veryfast',
  crf = 23,
  ...
  try {
    ...
    const ffmpegArgs = [
      ...
      '-vf', `scale='min(${width},iw)':-2`, // Scale to given width but maintain aspect ratio
      '-g', (keyframeInterval * 30).toString(), // Keyframe interval
