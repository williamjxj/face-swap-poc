      ...
      <div className="flex-1 bg-[#141518] p-4 md:p-6 overflow-y-auto pb-16 md:pb-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            <div className="mb-4">
              <svg className="w-16 h-16 text-gray-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="relative aspect-[116/176] overflow-hidden">
                    {getMediaType(media) === 'video' ? (
                      <>
                        ...
                        <video
                          ...
                          onError={(e) => {
                            ...
                            fallbackDiv.className = 'w-full h-full flex items-center justify-center bg-[#2a2d34]';
                            fallbackDiv.innerHTML = '<svg class="w-12 h-12 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>';
                      ...
                      <>
                        <Image 
                          src={
                            (media.thumbnailPath) ? media.thumbnailPath : 
                            (media.filePath && !media.filePath.match(/\.(mp4|webm|mov|avi)$/i)) ? media.filePath : 
